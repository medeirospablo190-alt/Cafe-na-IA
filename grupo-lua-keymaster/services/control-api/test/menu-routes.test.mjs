...
test("menu source URLs accept only HTTPS GitHub Lua files", () => {
  assert.match(validateMenuSourceUrl("https://github.com/user/repo/blob/main/Menu.lua"), /^https:\/\/github\.com\//);
  assert.match(validateMenuSourceUrl("https://raw.githubusercontent.com/user/repo/main/Menu.lua"), /^https:\/\/raw\.githubusercontent\.com\//);
