...
const s = StyleSheet.create({
  ...
  muted: { color: "rgba(235,235,240,0.62)", fontSize: 10, lineHeight: 15, marginTop: 3 },
  profileCard: { flexDirection: "row", alignItems: "center", gap: 12, borderRadius: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.14)", backgroundColor: "rgba(5,5,7,0.20)", padding: 14, marginTop: 12, marginBottom: 12 },
  profileDev: { borderColor: "rgba(211,59,68,0.52)" },
  avatar: { width: 48, height: 48, borderRadius: 24, borderWidth: 2, borderColor: "rgba(255,255,255,0.28)", backgroundColor: "rgba(0,0,0,0.28)", alignItems: "center", justifyContent: "center" },
  ...
  devBadge: { color: "#FF868C", fontSize: 8, fontWeight: "900", backgroundColor: "rgba(120,18,24,0.34)", borderRadius: 6, paddingHorizontal: 6, paddingVertical: 3 },
  previewMeta: { color: "rgba(225,225,232,0.56)", fontSize: 8, lineHeight: 13, marginTop: 5 },
  label: { color: "rgba(235,235,240,0.68)", fontSize: 9, fontWeight: "900", letterSpacing: 1.1, marginTop: 11 },
  input: { minHeight: 49, borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,255,255,0.16)", backgroundColor: "rgba(0,0,0,0.20)", color: "#FFF", paddingHorizontal: 13, marginTop: 7 },
  bio: { minHeight: 105, paddingTop: 12, paddingBottom: 12 },
  counter: { color: "rgba(225,225,232,0.50)", fontSize: 8, textAlign: "right", marginTop: 4 },
  choices: { flexDirection: "row", flexWrap: "wrap", gap: 7, marginTop: 7 },
  choice: { borderWidth: 1, borderColor: "rgba(255,255,255,0.16)", backgroundColor: "rgba(0,0,0,0.14)", borderRadius: 10, paddingHorizontal: 11, paddingVertical: 9 },
  choiceActive: { backgroundColor: "rgba(181,29,37,0.86)", borderColor: "rgba(255,105,111,0.58)" },
  choiceText: { color: "rgba(240,240,245,0.72)", fontSize: 8, fontWeight: "900" },
  choiceTextActive: { color: "#FFFFFF" },
  presenceHelp: { color: "rgba(225,225,232,0.56)", fontSize: 8, lineHeight: 13, marginTop: 7 },
  save: { minHeight: 50, borderRadius: 13, backgroundColor: "#B51D25", alignItems: "center", justifyContent: "center", marginTop: 18 },
  saveText: { color: "#FFFFFF", fontSize: 10, fontWeight: "900" },
  discard: { minHeight: 42, alignItems: "center", justifyContent: "center", marginTop: 5 },
  discardText: { color: "rgba(240,240,245,0.70)", fontSize: 8, fontWeight: "900" },
  disabled: { opacity: 0.45 },
  securityCard: { borderWidth: 1, borderColor: "rgba(255,255,255,0.14)", borderRadius: 15, backgroundColor: "rgba(5,5,7,0.18)", padding: 14, marginTop: 12 },
  securityRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  securityTitle: { color: "#FFF", fontSize: 13, fontWeight: "900" },
  securityState: { color: "rgba(240,240,245,0.70)", fontSize: 8, fontWeight: "900", marginTop: 4 },
  securityText: { color: "rgba(235,235,240,0.64)", fontSize: 10, lineHeight: 16, marginTop: 7 },
  quickButton: { minHeight: 38, borderRadius: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.18)", backgroundColor: "rgba(0,0,0,0.12)", paddingHorizontal: 12, alignItems: "center", justifyContent: "center" },
  quickButtonActive: { borderColor: "rgba(214,69,78,0.62)", backgroundColor: "rgba(95,15,20,0.34)" },
  quickButtonText: { color: "rgba(245,245,248,0.76)", fontSize: 8, fontWeight: "900" },
  quickButtonTextActive: { color: "#FF858B" },
  signOut: { minHeight: 49, borderRadius: 13, borderWidth: 1, borderColor: "rgba(177,68,78,0.64)", backgroundColor: "rgba(82,12,17,0.22)", alignItems: "center", justifyContent: "center", marginTop: 12, marginBottom: 8 },
  signOutText: { color: "#FF858B", fontSize: 10, fontWeight: "900", letterSpacing: 0.6 },
  errorCard: { borderWidth: 1, borderColor: "rgba(164,72,82,0.54)", borderRadius: 16, backgroundColor: "rgba(82,12,17,0.24)", padding: 15, marginTop: 12 },
  errorTitle: { color: "#FFF", fontSize: 14, fontWeight: "900" },
  errorText: { color: "#E1B0B5", fontSize: 10, lineHeight: 16, marginTop: 7 },
  retry: { minHeight: 44, borderRadius: 11, backgroundColor: "#B51D25", alignItems: "center", justifyContent: "center", marginTop: 12 },
