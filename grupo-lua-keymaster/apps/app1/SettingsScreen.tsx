...
const s = StyleSheet.create({
  ...
  profileCard: { flexDirection: "row", alignItems: "center", gap: 12, borderRadius: 16, borderWidth: 1, borderColor: "rgba(105,105,116,0.36)", backgroundColor: "rgba(6,6,9,0.38)", padding: 14, marginTop: 12, marginBottom: 12 },
  profileDev: { borderColor: "rgba(155,62,70,0.52)" },
  avatar: { width: 48, height: 48, borderRadius: 24, borderWidth: 2, borderColor: "rgba(115,115,128,0.58)", backgroundColor: "rgba(14,14,18,0.55)", alignItems: "center", justifyContent: "center" },
  ...
  devBadge: { color: "#FF686F", fontSize: 8, fontWeight: "900", backgroundColor: "rgba(33,10,12,0.55)", borderRadius: 6, paddingHorizontal: 6, paddingVertical: 3 },
  previewMeta: { color: "#8A8A93", fontSize: 8, lineHeight: 13, marginTop: 5 },
  label: { color: "#A0A0A8", fontSize: 9, fontWeight: "900", letterSpacing: 1.1, marginTop: 11 },
  input: { minHeight: 49, borderRadius: 12, borderWidth: 1, borderColor: "rgba(112,112,123,0.42)", backgroundColor: "rgba(10,10,14,0.42)", color: "#FFF", paddingHorizontal: 13, marginTop: 7 },
  bio: { minHeight: 105, paddingTop: 12, paddingBottom: 12 },
  counter: { color: "#85858E", fontSize: 8, textAlign: "right", marginTop: 4 },
  choices: { flexDirection: "row", flexWrap: "wrap", gap: 7, marginTop: 7 },
  choice: { borderWidth: 1, borderColor: "rgba(118,118,129,0.42)", backgroundColor: "rgba(8,8,12,0.34)", borderRadius: 10, paddingHorizontal: 11, paddingVertical: 9 },
  choiceActive: { backgroundColor: "#FFF", borderColor: "#FFF" },
  choiceText: { color: "#B3B3BB", fontSize: 8, fontWeight: "900" },
  choiceTextActive: { color: "#070708" },
  presenceHelp: { color: "#92929A", fontSize: 8, lineHeight: 13, marginTop: 7 },
  ...
  discardText: { color: "#B2B2BA", fontSize: 8, fontWeight: "900" },
  disabled: { opacity: 0.45 },
  securityCard: { borderWidth: 1, borderColor: "rgba(104,104,114,0.38)", borderRadius: 15, backgroundColor: "rgba(6,6,9,0.36)", padding: 14, marginTop: 12 },
  securityRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  securityTitle: { color: "#FFF", fontSize: 13, fontWeight: "900" },
  securityState: { color: "#AFAFB7", fontSize: 8, fontWeight: "900", marginTop: 4 },
  securityText: { color: "#A0A0A8", fontSize: 10, lineHeight: 16, marginTop: 7 },
  quickButton: { minHeight: 38, borderRadius: 10, borderWidth: 1, borderColor: "rgba(125,125,136,0.48)", paddingHorizontal: 12, alignItems: "center", justifyContent: "center" },
  quickButtonActive: { borderColor: "rgba(176,73,82,0.64)", backgroundColor: "rgba(27,9,11,0.48)" },
  quickButtonText: { color: "#D0D0D5", fontSize: 8, fontWeight: "900" },
  quickButtonTextActive: { color: "#FF757B" },
  signOut: { minHeight: 49, borderRadius: 13, borderWidth: 1, borderColor: "rgba(177,68,78,0.64)", backgroundColor: "rgba(24,7,9,0.38)", alignItems: "center", justifyContent: "center", marginTop: 12, marginBottom: 8 },
  signOutText: { color: "#FF858B", fontSize: 10, fontWeight: "900", letterSpacing: 0.6 },
  errorCard: { borderWidth: 1, borderColor: "rgba(164,72,82,0.54)", borderRadius: 16, backgroundColor: "rgba(16,7,8,0.42)", padding: 15, marginTop: 12 },
  errorTitle: { color: "#FFF", fontSize: 14, fontWeight: "900" },
  errorText: { color: "#D2A2A7", fontSize: 10, lineHeight: 16, marginTop: 7 },
