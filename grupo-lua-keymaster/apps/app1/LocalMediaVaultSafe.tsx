...
const s = StyleSheet.create({
  root: { flex: 1 },
  loadingCard: { minHeight: 110, borderRadius: 16, borderWidth: 1, borderColor: "#292930", backgroundColor: "#09090C", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 18 },
  loadingText: { color: "#77777F", fontSize: 9 },
  organizerRow: { flexDirection: "row", alignItems: "center", gap: 10, borderRadius: 14, borderWidth: 1, borderColor: "#2A2430", backgroundColor: "#0C090F", padding: 11, marginTop: 18 },
  organizerTitle: { color: "#FFF", fontSize: 10, fontWeight: "900" },
  organizerText: { color: "#726A78", fontSize: 8, lineHeight: 13, marginTop: 3 },
  organizerButton: { minHeight: 38, borderRadius: 10, borderWidth: 1, borderColor: "#4A3559", backgroundColor: "#160F1B", alignItems: "center", justifyContent: "center", paddingHorizontal: 11 },
  ...
  modalEyebrow: { color: "#9B78B0", fontSize: 8, fontWeight: "900", letterSpacing: 1 },
  modalTitle: { color: "#FFF", fontSize: 19, fontWeight: "900", marginTop: 4 },
  close: { color: "#A0A0A8", fontSize: 18, padding: 7 },
  managerList: { marginTop: 12 },
  managerListContent: { paddingBottom: 4 },
  empty: { color: "#717178", fontSize: 10, textAlign: "center", paddingVertical: 24 },
  itemRow: { flexDirection: "row", alignItems: "center", gap: 10, borderRadius: 12, borderWidth: 1, borderColor: "#25252B", backgroundColor: "#0D0D10", padding: 11, marginBottom: 7 },
  itemName: { color: "#FFF", fontSize: 10, fontWeight: "800" },
  itemMeta: { color: "#626269", fontSize: 7, fontWeight: "900", marginTop: 4 },
  renameButton: { minHeight: 34, borderRadius: 9, borderWidth: 1, borderColor: "#3F3248", paddingHorizontal: 9, alignItems: "center", justifyContent: "center" },
  renameButtonText: { color: "#CDB0DD", fontSize: 7, fontWeight: "900" },
  input: { minHeight: 50, borderRadius: 12, borderWidth: 1, borderColor: "#33333A", backgroundColor: "#111114", color: "#FFF", paddingHorizontal: 12, marginTop: 13 },
  counter: { color: "#626269", fontSize: 8, textAlign: "right", marginTop: 4 },
  ...
  cancelButtonText: { color: "#85858D", fontSize: 8, fontWeight: "900" }
});
