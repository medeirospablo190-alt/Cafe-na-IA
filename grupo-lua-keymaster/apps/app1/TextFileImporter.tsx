...
const s = StyleSheet.create({
  ...
  modalEyebrow: { color: "#8D5EB5", fontSize: 9, fontWeight: "900", letterSpacing: 1.2 },
  modalTitle: { color: "#FFFFFF", fontSize: 21, fontWeight: "900", marginTop: 4 },
  sourceName: { color: "#787880", fontSize: 10, marginTop: 4 },
  ...
  counter: { color: "#76767E", fontSize: 10, textAlign: "right", marginTop: 6 },
