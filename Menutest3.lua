--==============================================================--
-- CAFEÍNA • EGG FAST SAFE V4 • PATHFIND
...
local CONFIG = {
    GUI_NAME = "CafeinaEggFastSafeV4Pathfind",
    ...
    STUCK_SECONDS = 1.15,
    STUCK_MIN_PROGRESS = 1.25,
    REPATH_COOLDOWN = 0.35,

    -- Timeout por waypoint.
    WAYPOINT_TIMEOUT = 2.2,
...
Title.Text = "CAFEÍNA • EGG FAST SAFE"
...
local function beginCarry(uid, area)
    ...
    setStatus(
        "Ovo confirmado ✓ • iniciando corrida"
    )
...
if FieldEggCarry or FieldEggShifted then
    setStatus(
        "Pronto • rota normal + desvio de paredes"
    )
else
    setStatus(
...
print(
    "[CAFEÍNA] EGG FAST SAFE V4 PATHFIND carregado."
)
