--==============================================================--
--        CAFEÍNA GAME EXPLORER V6 • STREAMING EXPORT
--==============================================================--
--
...
local CONFIG = {
    ...
    FULL_EXPORT_MAX_OBJECTS = 250000,
...
local function uploadStartSession(metadata)
    local payload = {
        filename = "Cafeina_Explorer_Completo.json",
        source = "cafeina-game-explorer",
        metadata = metadata,
    }
...
Main.Size = UDim2.new(0.95, 0, 0.86, 0)
Main.Position = UDim2.new(0.025, 0, 0.07, 0)
...
Constraint.MaxSize = Vector2.new(720, 800)
...
ExportPanel.Size = UDim2.new(1, -14, 0, 97)
ExportPanel.Position = UDim2.fromOffset(7, 62)
...
ExportTitle.Size = UDim2.new(1, -208, 0, 19)
ExportTitle.Position = UDim2.fromOffset(9, 4)

local ExportStatus = label(
    ExportPanel,
    "Pronto para gerar e enviar o relatório completo.",
    8,
    COLORS.SUB
)
ExportStatus.Size = UDim2.new(1, -208, 0, 18)
ExportStatus.Position = UDim2.fromOffset(9, 22)
...
UploadAll.Size = UDim2.fromOffset(92, 32)
UploadAll.Position = UDim2.new(1, -198, 0, 7)
UploadAll.BackgroundColor3 = COLORS.RED_DARK
UploadAll.TextSize = 8

local CancelUpload = button(
    ExportPanel,
    "CANCELAR"
)
CancelUpload.Size = UDim2.fromOffset(92, 32)
CancelUpload.Position = UDim2.new(1, -101, 0, 7)
CancelUpload.TextSize = 8
CancelUpload.Visible = false

local ExportProgressBG = Instance.new("Frame")
ExportProgressBG.Size = UDim2.new(1, -18, 0, 7)
ExportProgressBG.Position = UDim2.fromOffset(9, 43)
...
DownloadLink.Size = UDim2.new(1, -112, 0, 32)
DownloadLink.Position = UDim2.fromOffset(9, 57)
...
CopyDownloadLink.Size = UDim2.fromOffset(94, 32)
CopyDownloadLink.Position = UDim2.new(1, -103, 0, 57)
CopyDownloadLink.TextSize = 8
CopyDownloadLink.BackgroundColor3 = COLORS.PANEL3
...
ScanBar.Size = UDim2.new(1, -14, 0, 64)
ScanBar.Position = UDim2.fromOffset(7, 253)
...
ScanButton.Size = UDim2.fromOffset(78, 34)
ScanButton.Position = UDim2.fromOffset(7, 7)
...
ScanStatus.Size = UDim2.new(1, -98, 0, 21)
ScanStatus.Position = UDim2.fromOffset(93, 4)
ScanStatus.TextTruncate = Enum.TextTruncate.AtEnd

local ProgressBG = Instance.new("Frame")
ProgressBG.Size = UDim2.new(1, -100, 0, 8)
ProgressBG.Position = UDim2.fromOffset(93, 31)
...
ScanHint.Size = UDim2.new(1, -220, 0, 16)
ScanHint.Position = UDim2.fromOffset(7, 45)
ScanHint.TextTruncate = Enum.TextTruncate.AtEnd

local CopyScan = button(ScanBar, "COPIAR")
CopyScan.Size = UDim2.fromOffset(64, 26)
CopyScan.Position = UDim2.new(1, -207, 0, 35)
CopyScan.TextSize = 8

local ExportScan = button(ScanBar, "LOCAL")
ExportScan.Size = UDim2.fromOffset(64, 26)
ExportScan.Position = UDim2.new(1, -139, 0, 35)
ExportScan.TextSize = 8

local UploadScan = button(ScanBar, "SERVIDOR")
UploadScan.Size = UDim2.fromOffset(64, 26)
UploadScan.Position = UDim2.new(1, -71, 0, 35)
UploadScan.TextSize = 8
...
Left.Size = UDim2.new(1, -14, 1, -372)
Left.Position = UDim2.fromOffset(7, 324)
...
-- Inspector em tela de detalhe, sobre a lista.
local Right = Instance.new("Frame")
Right.Size = UDim2.new(1, -14, 1, -372)
Right.Position = UDim2.fromOffset(7, 324)
...
InspectorBack.Size = UDim2.fromOffset(32, 28)
InspectorBack.Position = UDim2.fromOffset(5, 4)
...
DetailsTitle.Size = UDim2.new(1, -48, 0, 29)
DetailsTitle.Position = UDim2.fromOffset(43, 3)
...
CopySelected.Size = UDim2.new(0.33, -3, 1, 0)
CopySelected.Position = UDim2.new(0, 0, 0, 0)
CopySelected.BackgroundColor3 = COLORS.PANEL3

local ExportSelected = button(InspectorActions, "LOCAL")
ExportSelected.Size = UDim2.new(0.33, -3, 1, 0)
ExportSelected.Position = UDim2.new(0.33, 2, 0, 0)
ExportSelected.BackgroundColor3 = COLORS.PANEL3

local UploadSelected = button(InspectorActions, "SERVIDOR")
UploadSelected.Size = UDim2.new(0.34, -3, 1, 0)
UploadSelected.Position = UDim2.new(0.66, 4, 0, 0)
...
DetailsText.Text = "Selecione um objeto para ver informações."
...
local function setScanStatus(text, progress, color)
...
local function buildDetails(inst)
    if not inst then
        return "Nenhum objeto selecionado."
    end
