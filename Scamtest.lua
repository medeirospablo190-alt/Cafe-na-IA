...
--==============================================================--
-- SMART STORAGE • HISTÓRICO COMPLETO DE ALTERAÇÕES
--==============================================================--
...
local function storeRecord(record)
    ...
    -- Mesmo objeto e mesmo estado do último snapshot:
    -- descarta somente a repetição idêntica.
    if
        lastFingerprint
        and lastFingerprint
        == fingerprint
    ...
    -- Preserva toda alteração como um novo registro.
    -- Nunca substitui registros anteriores.
    record.objectKey =
        objectKey
...
create(
    "TextLabel",
    {
        ...
        Text =
            "Scamtest.lua • V6 • histórico completo",
...
print(
    "[CAFEINA] Scamtest.lua V6 carregado."
)
