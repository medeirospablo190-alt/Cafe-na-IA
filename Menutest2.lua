...
local CONFIG = {
    VERSION = "MORPH_TRACE_V1_0",
    GUI_NAME = "CafeinaMorphTraceV10",
...
Main.Size=UDim2.fromOffset(322,320)
...
Send.Position=UDim2.fromOffset(10,115)
...
Status.Position=UDim2.fromOffset(10,165)
...
DataLabel.Position=UDim2.fromOffset(10,205)
...
CountLabel.Position=UDim2.fromOffset(10,225)
...
UploadLabel.Position=UDim2.fromOffset(10,246)
...
Bar.Position=UDim2.fromOffset(10,274)
...
print("[CAFEÍNA] MORPH TRACE V1.0 carregado.")
